...
@Composable
fun CreateExercise(onBackCreateExercise: () -> Unit) {
    ...
    Column(modifier = Modifier.background(screenLight)) {
        Column(
            ...
            Column(
                ...
                Surface(shape = RoundedCornerShape(16.dp), modifier = Modifier.padding(bottom = 56.dp, top = 0.dp, start = 56.dp, end = 56.dp)) {
                    Column(
                        modifier = Modifier
                            .background(
                        ...
                        InputItem(state = nomeState, text = "Nome do exercício", passwordVisualTransformation = VisualTransformation.None)
                        InputItem(state = urlState, text = "Imagem/Vídeo da execução", passwordVisualTransformation = VisualTransformation.None)
                        InputItem(state = observacaoState, text = "Observações", passwordVisualTransformation = VisualTransformation.None, lines = 3)
                        Spacer(modifier = Modifier.padding(0.dp))
                        ButtonItem(text = "Cadastrar", icon = null, colorButton = primaryLight, colorText = textDark) {
