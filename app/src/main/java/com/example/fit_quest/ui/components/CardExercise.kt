...
@Composable
fun CardExercise(onCardExerciseClick: () -> Unit, modifier: Modifier) {
    Button(
        onClick = onCardExerciseClick,
        ...
        Card(
            ...
            Text(modifier = Modifier.fillMaxWidth(), text = "Exercício", textAlign = TextAlign.Center)
        }
    }
}